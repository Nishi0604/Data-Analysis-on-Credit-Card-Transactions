...
/* sixth query solution %age of spends by 
females for each type of expense */	
with cte1 as(
...
/* seventh query card,expense type 
combination saw highest month over 
